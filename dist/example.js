...
window.addEventListener("load", function () {
    function from163(id) {
        if (!id)
            throw new Error("Unable Property.");
        return fetch("https://music.huaji8.top/?id=" + id).then(function (res) { return res.json(); }).then((data) => {
            let obj = {
    ...
    window.demoPlayer = players[0];
    window.demoPlayers = players;
